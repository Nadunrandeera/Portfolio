...
const Contact = () => {
  const { formData, errors, isSubmitting, submitStatus, handleSubmit, handleChange } =
    useContactForm();
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-600 dark:text-gray-300">nadunrandeera@gmail.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2" />
                <span className="text-gray-600 dark:text-gray-300">+94 71 076 39 69</span>
              </div>
              <div className="flex items-center">
                <MapPin className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2" />
                <span className="text-gray-600 dark:text-gray-300">Kurunegala , Sri Lanka</span>
              </div>
            </div>
          </div>
